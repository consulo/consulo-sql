...
package consulo.sql.language.impl.oracle.test;

import consulo.language.file.LanguageFileType;
import consulo.language.version.LanguageVersion;
import consulo.sql.language.SqlFileType;
import consulo.sql.language.SqlLanguage;
import consulo.sql.language.impl.oracle.OracleLanguageVersion;
 ...
 * @since 2026-05-03
 */
public class OracleParsingTest extends SimpleParsingTest<Object> {
    public OracleParsingTest() {
        super("oracleParsing", "sql");
    }
    ...
    protected LanguageVersion resolveLanguageVersion(Context context, @Nullable Object testContext, FileType fileType) {
        return SqlLanguage.INSTANCE.findVersionByClass(OracleLanguageVersion.class);
    }
}
