...
package consulo.sql.language.impl.hql.test;

import consulo.language.file.LanguageFileType;
import consulo.language.version.LanguageVersion;
import consulo.sql.language.SqlFileType;
import consulo.sql.language.SqlLanguage;
import consulo.sql.language.impl.hql.HqlLanguageVersion;
 ...
 * @since 2026-05-03
 */
public class HqlParsingTest extends SimpleParsingTest<Object> {
    public HqlParsingTest() {
        super("hqlParsing", "sql");
    }
    ...
    @Test
    public void testPathFunctionElements(Context context) throws Exception {
        doTest(context, null);
    }

    @Test
    public void testPathFunctionIndices(Context context) throws Exception {
        doTest(context, null);
    }
    ...
    protected LanguageVersion resolveLanguageVersion(Context context, @Nullable Object testContext, FileType fileType) {
        return SqlLanguage.INSTANCE.findVersionByClass(HqlLanguageVersion.class);
    }
}
