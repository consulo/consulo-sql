...
package consulo.sql.language.impl.mysql.test;
 ...
 * @since 2026-05-03
 */
public class MySqlParsingTest extends SimpleParsingTest<Object> {
    public MySqlParsingTest() {
        super("mysqlParsing", "sql");
    }
    ...
    protected LanguageVersion resolveLanguageVersion(Context context, @Nullable Object testContext, FileType fileType) {
        return SqlLanguage.INSTANCE.findVersionByClass(MySqlLanguageVersion.class);
    }
}
