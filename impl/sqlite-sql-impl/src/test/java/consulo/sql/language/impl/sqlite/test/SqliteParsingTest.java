...
package consulo.sql.language.impl.sqlite.test;

import consulo.language.file.LanguageFileType;
import consulo.language.version.LanguageVersion;
import consulo.sql.language.SqlFileType;
import consulo.sql.language.SqlLanguage;
import consulo.sql.language.impl.sqlite.SqliteLanguageVersion;
 ...
 * @since 2026-05-03
 */
public class SqliteParsingTest extends SimpleParsingTest<Object> {
    public SqliteParsingTest() {
        super("sqliteParsing", "sql");
    }
    ...
    protected LanguageVersion resolveLanguageVersion(Context context, @Nullable Object testContext, FileType fileType) {
        return SqlLanguage.INSTANCE.findVersionByClass(SqliteLanguageVersion.class);
    }
}
