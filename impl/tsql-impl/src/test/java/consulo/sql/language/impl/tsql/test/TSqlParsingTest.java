...
package consulo.sql.language.impl.tsql.test;

import consulo.language.file.LanguageFileType;
import consulo.language.version.LanguageVersion;
import consulo.sql.language.SqlFileType;
import consulo.sql.language.SqlLanguage;
import consulo.sql.language.impl.tsql.TSqlLanguageVersion;
 ...
 * @since 2026-05-03
 */
public class TSqlParsingTest extends SimpleParsingTest<Object> {
    public TSqlParsingTest() {
        super("tsqlParsing", "sql");
    }
    ...
    protected LanguageVersion resolveLanguageVersion(Context context, @Nullable Object testContext, FileType fileType) {
        return SqlLanguage.INSTANCE.findVersionByClass(TSqlLanguageVersion.class);
    }
}
