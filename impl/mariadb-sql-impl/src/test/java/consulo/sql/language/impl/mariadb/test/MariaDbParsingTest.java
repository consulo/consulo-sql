...
package consulo.sql.language.impl.mariadb.test;
 ...
 * @since 2026-05-03
 */
public class MariaDbParsingTest extends SimpleParsingTest<Object> {
    public MariaDbParsingTest() {
        super("mariadbParsing", "sql");
    }
    ...
    protected LanguageVersion resolveLanguageVersion(Context context, @Nullable Object testContext, FileType fileType) {
        return SqlLanguage.INSTANCE.findVersionByClass(MariaDbLanguageVersion.class);
    }
}
